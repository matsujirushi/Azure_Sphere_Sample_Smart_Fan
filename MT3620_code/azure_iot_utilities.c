...
//
// Note: this connection string is specific to the device "devkit-seeed". To configure other devices,
...
bool AzureIoT_SetupClient(void)
{
    ...
    IOTHUB_CLIENT_RESULT azureRes = IoTHubDeviceClient_LL_SetOption(
        iothub_client_handle, "TrustedCerts", AzureIoTCertificatesX);
    ...
    if (IoTHubDeviceClient_LL_SetRetryPolicy(iothub_client_handle, IOTHUB_CLIENT_RETRY_INTERVAL,
